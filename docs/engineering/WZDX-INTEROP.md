...
⚠ ممنوع قراءة هذه النتيجة قياساً مرورياً أو دليلاً على صحة أي رقم في مسار. التبادلية بنية لا قياس، وتغذية ولايةٍ أخرى لا تقول شيئاً عن الرياض.
...
مُخرَج مسار يمرّ على جزء من المخطط: حدثٌ واحد من نوع `work-zone`،
