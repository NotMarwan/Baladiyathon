/**
 * مسار — الحل على الخريطة: البطاقة تصير قراراً، والشريط يعلن الوفر.
 * ---------------------------------------------------------------------------
 ...
 * 3) الأرقام تُقرأ ولا تُحسب هنا — الحساب تم عند البناء بمحرك مسار نفسه.
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    ...
    root.MasarWorksMapSolution = factory();
  }
   ...
   * @param {object} result ناتج MasarCityRouting.alternativesAround
