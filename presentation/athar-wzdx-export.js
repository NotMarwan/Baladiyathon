/**
 * أثر — مُصدِّر WZDx: من سجل تصريح داخلي إلى تغذية معيارية، أو إلى رفضٍ مُعلَّل.
 * ---------------------------------------------------------------------------
 * **لماذا طبقة بين المحفظة والمحرك.**
 *
 * `AtharEngine.wzdx` يبني البنية ويحرس التعدادات، ولا يعرف شيئاً عن العربية
 ...
 *
 *   · يحوّل الاتجاه عبر `AtharWzdxMapping` — أو يرفض التصريح باسمه وسببه.
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('./athar-engine.js'),
      require('./athar-wzdx-mapping.js'));
  } else {
    root.AtharWzdxExport = factory(root.AtharEngine, root.AtharWzdxMapping);
  }
  ...
  function buildFeed(feature, options) {
    ...
    try {
      feed = Engine.wzdx({
        ...
        dataSourceId: settings.dataSourceId || 'athar-reviewer-desk',
