/**
 * مسار — المباني حسب ما يُرى، لا حسب أين كانت الكاميرا.
 * ---------------------------------------------------------------------------
 ...
 *
 * UMD بنفس نمط masar-engine.js. الدوال الحاسبة نقية — تُختبر في Node بلا خريطة.
 */
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    ...
    root.MasarBuildingsLazy = factory();
  }
