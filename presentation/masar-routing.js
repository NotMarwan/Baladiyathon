/**
 * MasarRouting — real alternative-route computation on a local road network.
 * Pure computation: no DOM, no fetch, no Date.now(). Shared verbatim by the
 * browser UI and the Node test suite (same UMD pattern as masar-engine.js).
 *
 ...
 *
 * UMD export: `window.MasarRouting` in the browser, `module.exports` in Node.
 */
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    module.exports = factory();
  } else {
    root.MasarRouting = factory();
  }
