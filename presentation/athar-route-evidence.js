/**
 * أثر — عقد قياس المسارات ودرجات الدليل.
 * ---------------------------------------------------------------------------
 * **المشكلة التي يعالجها.**
 *
 * كل رقم في «أثر» اليوم مشتقٌّ من نموذج. والنموذج معايَر على لا شيء محلي:
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    ...
    root.AtharRouteEvidence = factory();
  }
  ...
  /* لماذا اتّسع السُّلَّم من سبع درجات إلى تسع.
     ...
     والسقف لم يتحرك: `local-field` تبقى وحدها ما يفتح كلمة «أثر»، وتبقى
  ...
  var EVIDENCE_GRADES = [
    ...
    },
    {
      ...
      what: 'ناتج محرك أثر من مدخلات وافتراضات معلنة.',
      narrows: false,
      calibrates: false,
