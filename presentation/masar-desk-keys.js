...
(function (root, factory) {
  ...
  var HELP = [
    ...
    { keys: 'Ctrl/⌘ + K', label: 'لوحة الأوامر — اقفز إلى تصريح أو شارع أو إجراء' },
    { keys: '/', label: 'البحث' },
  ...
  function resolve(event, context) {
    ...
    /**
     * الاستثناء الوحيد لقاعدة المُعدِّلات: Ctrl+K و⌘K.
     * القاعدة تمنع اختطاف اختصارات المتصفح، وهذا الموضع بالذات ليس اختصار
     * متصفح بل الرابط المتعارف عليه للوحة الأوامر في كل أداة يعرفها المراجع.
     * منعه هنا يعني أن يجرّبه ولا يجد شيئاً — وهو أسوأ من عدم وجود اللوحة.
     */
    if ((event.ctrlKey || event.metaKey) && !event.altKey && event.code === 'KeyK') {
      return { intent: 'palette', arg: null };
    }

    // ما عدا ذلك: اختصار بمُعدِّل ليس اختصارنا. النسخ والتبويب وغيرهما تمر.
