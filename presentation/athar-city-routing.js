/**
 * أثر — المسارات البديلة على شبكة الرياض كاملة.
 * ---------------------------------------------------------------------------
 ...
 *
 * UMD بنفس نمط athar-engine.js. نقية تماماً — تأخذ رسماً وتعيد مسارات،
...
(function (root, factory) {
  ...
  /**
   * حصة الساعة من الحركة اليومية — نفس ملف athar-routing.js.
   ...
   *
   * القاعدة هي المعلنة نفسها في محرك الممر (`athar-routing.js`): حصةُ الطلب
