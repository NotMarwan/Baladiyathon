/**
 * مسار — مُقلع صفحة رحلة المستخدم. تبويب مؤقّت (انظر رأس `masar-journey.html`).
...
(function () {
  ...
  if (!canvas || typeof MasarJourneyModel === 'undefined'
    || typeof MasarJourneyDiagram === 'undefined') {
    if (canvas) {
  ...
  canvas.innerHTML = MasarJourneyDiagram.render(MasarJourneyModel);
  ...
  var ordered = MasarJourneyModel.NODES.slice().sort(function (a, b) {
