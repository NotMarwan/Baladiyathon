/**
 * مسار — تصيير الفهرس: الصفحة الرئيسية والنظرة العامة والتفاصيل المتقدمة.
 * ---------------------------------------------------------------------------
 * دوال نقية تعيد نصاً، تقرأ من `masar-catalog.js` وحده. الصفحات لا تكتب
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('./masar-catalog.js'));
  } else {
    root.MasarCatalogView = factory(root.MasarCatalog);
  }
  ...
  function renderHero() {
    ...
    return '<h1>' + escapeHtml(p.name) + ' — ' + escapeHtml(p.tagline) + '</h1>'
      ...
      + '<p class="ac-cta-row">'
      + '<a class="ac-cta" href="masar-desk.html">ابدأ من مكتب المراجع</a>'
      + '<a class="ac-cta-secondary" href="masar-map.html">أو اعرض الخريطة العامة</a>'
      + '</p>'
  ...
  function renderStatusStrip() {
    ...
    return '<h2 id="status">حالة المشروع الآن</h2>'
      ...
      + '<p class="ac-cta-row">'
      + '<a class="ac-cta-secondary" href="masar-overview.html">افتح نظرة عامة على النظام</a>'
      + '</p>';
  }
  ...
  function renderSources() {
    return '<h2 id="sources">مصادر البيانات</h2>'
      ...
      + '<a href="masar-sources.html">سجل المصادر</a>.</p>'
      + '<div class="ac-table-wrap"><table class="ac-table">'
      ...
      + Catalog.SOURCES.map(function (source) {
        return '<tr><th scope="row"><code>' + escapeHtml(source.id) + '</code></th>'
          + '<td><a href="masar-sources.html#' + escapeHtml(source.id) + '">'
