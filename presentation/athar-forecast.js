/**
 * AtharForecast — honest congestion-forecast layer. Pure computation, no DOM.
 *
 ...
 * «افتراض توضيحي للعرض».
 *
 * UMD export: `window.AtharForecast` in the browser, `module.exports` in Node.
 */
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    module.exports = factory();
  } else {
    root.AtharForecast = factory();
  }
