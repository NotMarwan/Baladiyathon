/**
 * مسار — راسم مخطط النشاط (UML Activity Diagram) من نموذج الرحلة.
 * ---------------------------------------------------------------------------
 * تبويب مؤقّت — انظر رأس `masar-journey-model.js`.
 *
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    ...
    root.MasarJourneyDiagram = factory();
  }
  ...
  function render(model) {
    ...
    return '<svg class="journey-svg" viewBox="0 0 ' + W + ' ' + height + '" width="' + W
      ...
      + ' aria-label="مخطط نشاط UML لرحلة المراجع داخل مسار — من الدخول حتى النتيجة">'
