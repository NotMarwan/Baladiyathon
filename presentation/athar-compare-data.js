/**
 * أثر — مقارنة المنافسين (WP-C1).
 * ---------------------------------------------------------------------------
 * كل ما هنا منقول من `research/2026-07-23/athar-competitor-benchmarks/`
...
(function (root, factory) {
  ...
  /* `known` يفصل ما نعرفه عمّا لا نعرفه.
     ...
     تفوّقاً: منافسٌ لا نعرف عنه شيئاً يبدو متقدّماً على أثر في بُعدٍ لا
  ...
  var DIMENSIONS = [
    {
      ...
      athar: { state: 'absent', note: 'أثر لا يُصدر تصريحاً ولا يدّعي ذلك.' },
      competitors: {
    ...
    },
    {
      ...
      athar: { state: 'absent', note: 'لا مستشعرات ولا تغذية حية. النموذج يعمل على بيانات ثابتة.' },
      competitors: {
    ...
    },
    {
      ...
      athar: { state: 'absent', note: 'نموذج أوليّ على جهاز واحد. لا مستخدمين ولا تشغيل.' },
      competitors: {
