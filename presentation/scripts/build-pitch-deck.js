 ...
 *   2030 — جزء من اسم «رؤية 2030»: اسم علم لا قياس.
 *   3، 100 — رقما هدف رؤية 2030 المنشور بنصّه («وصول 3 مدن سعودية لقائمة
 *            أفضل 100 مدينة ملائمة للعيش») — رقما الجهة لا تقديرنا، وسندهما
 *            src-045 في سجل الأدلة. لا يدخلان الجرد لأنهما ليسا من إنتاج
 *            المستودع، والجرد لما يولّده المستودع وحده.
 */
const ALLOWED = /^(4\.2|2026|2030|0045|14\.9|500|3|100)$/;
