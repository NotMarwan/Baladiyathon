/**
 * مسار — نموذج رحلة المستخدم (UML Activity Diagram).
 * ---------------------------------------------------------------------------
 * تبويب مؤقّت. حذفه سطرٌ في `masar-nav.js` وثلاثة ملفات — لا يمسّ المنتج.
 *
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    ...
    root.MasarJourneyModel = factory();
  }
  ...
  var NODES = [
    ...
    { id: 'filter', lane: 'user', row: 10, kind: 'action',
      ...
      ref: 'masar-desk-inbox.js#renderToolbar' },
    ...
    { id: 'guard', lane: 'system', row: 22, kind: 'system',
      ...
      ref: 'masar-desk-states.js#guard' },

    { id: 'allowed', lane: 'system', row: 23, kind: 'decision',
      label: 'الإجراء مسموح؟', ref: 'masar-desk-states.js#actionsFor' },
    ...
    { id: 'next', lane: 'system', row: 32, kind: 'system',
      ...
      ref: 'masar-desk-store.js#nextPending' },

    { id: 'queueLeft', lane: 'system', row: 33, kind: 'decision',
      label: 'بقي عمل ينتظر؟', ref: 'masar-desk-store.js#DECISION_STATUSES' },
