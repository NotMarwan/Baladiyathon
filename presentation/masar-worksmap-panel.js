/**
 * مسار — لوحة التحكم بالخريطة (الفترة الزمنية + إظهار الطبقات + قائمة السجلات)
 * ---------------------------------------------------------------------------
...
(function (root, factory) {
   ...
   *
   * تُقرأ من `MasarWorksMapSolution` نفسه حين يكون محمَّلاً، فلا ينحرف نصّان
   * يصفان شيئاً واحداً.
   */
  function routeLegendRows() {
    var Solution = typeof MasarWorksMapSolution !== 'undefined' ? MasarWorksMapSolution : null;
  ...
  function mount(root, api, nowMs, groups) {
    ...
    var list = groups || (scope.MasarWorksMapLayers && scope.MasarWorksMapLayers.LAYER_GROUPS) || [];
