/**
 * مسار — عقد بيانات التصريح (WP-I1).
 * ---------------------------------------------------------------------------
 * **ما هذا الملف، وما ليس.**
 *
 * هو **وصفٌ ومحقِّق**: يقول ما الذي يحتاجه محرك مسار من منصة التصريح ليعمل،
...
(function (root, factory) {
  ...
  if (typeof module === 'object' && module.exports) {
    ...
    root.MasarPermitContract = factory(root.MasarEngine);
  }
  ...
  var FIELDS = [
    ...
    },
    {
      ...
      fallback: 'قيمة الصنف المعلنة في masar-engine',
      check: function (value) {
  ...
  /**
   * يحوّل سجل العقد إلى مُدخل `masar-engine`.
   *
