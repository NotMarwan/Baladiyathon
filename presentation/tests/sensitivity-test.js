...
test('كل افتراض يحمل تعليل نطاقه ونوعه', () => {
  /* `افتراض معلن` أُضيف حين فُصل الدليل المقيس عن أرضية النمذجة: قيمةٌ
     يعترف النموذج بأنها بلا سند، وتمييزها عن `محسوب` هو الغرض — خلطهما
     يجعل الأرضية تُقرأ ثابتاً مشتقّاً. */
  const kinds = ['محسوب', 'وزن معلن', 'مُدخل غير مقيس', 'افتراض معلن'];
