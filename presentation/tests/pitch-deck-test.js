...
test('كل رقم مرئي مسنود بسطر في الجرد', () => {
  ...
  /* 2030 و3 و100: اسم الرؤية ورقما هدفها المنشور بنصّه («وصول 3 مدن سعودية
     لقائمة أفضل 100 مدينة ملائمة للعيش») — أرقام الجهة لا تقديرنا، وسندها
     src-045. لا تدخل الجرد لأنها ليست من إنتاج المستودع. القائمة هنا مرآة
     قائمة الباني في `build-pitch-deck.js` — من عدّل إحداهما عدّل الأخرى. */
  const ALLOWED = new Set(['4.2', '2026', '2030', '0045', '14.9', '500', '3', '100']);
