...
We now have ONE project: **Athar (أثر)** — Challenge 3, Baladiyathon 2026. Everything else is finished and archived. If you were doing anything else, stop and switch to Athar.
...
4. Demo script: `SwarmingObsidian/01 Athar/Demo Script.md`
5. Official rules (submission fields): `SwarmingObsidian/99 Archive/Reference/Official Hackathon Rules.md`
...
## 🛠️ YOUR Athar task — Agent 4: Pitch + submission
- Build a 3-minute **pitch deck** as HTML slides (`presentation/athar-pitch.html`) matching the dossier's visual style, following `Demo Script.md`, ending on the **"طبقة ذكاء بلدي"** platform slide.
- Draft the **Idea-Card submission text** (map to the official form fields: target challenge, idea name + description, chosen emerging tech, team, attachments plan).
Save the idea-card text to `SwarmingObsidian/01 Athar/Idea Card.md` and link from `00 Athar - Home.md`.
