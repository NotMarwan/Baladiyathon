...
4. Extra capabilities: `SwarmingObsidian/01 Athar/New Capabilities (research).md`
5. Merges & fixes applied: `SwarmingObsidian/01 Athar/Merges & Fixes.md`
...
- **NO drones, no personal data.** Athar has none — keep it that way.

## 🛠️ YOUR Athar task — Agent 1: Interactive prototype UI
Build `C:/Users/wasan/Downloads/Swarm/presentation/athar-prototype.html` — a self-contained page (match the visual style of `athar-merged.html`):
...
Then drop a one-paragraph summary + screenshot note into `SwarmingObsidian/01 Athar/Prototype.md` and link it from `00 Athar - Home.md`.
