...
## 🛠️ YOUR Athar task — Agent 2: Impact engine (always-on)
Build the scoring engine (as `presentation/athar-engine.js` or an inline module Agent 1 can import):
...
Provide sample inputs/outputs. Cite the emission factor + FHWA cost source in a Sources Ledger. Summarize in `SwarmingObsidian/01 Athar/Engine.md`.
