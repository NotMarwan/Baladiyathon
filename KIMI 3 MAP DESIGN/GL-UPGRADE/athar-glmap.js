/**
 * أثر — خريطة GL المملوكة (MapLibre GL، بلا بلاط، بلا خوادم خطوط)
 * ---------------------------------------------------------------------------
 * المبرر (10 أسطر):
  ...
  function init(container, geojson, opts) {
    ...
    map.on('load', function () {
      ...
      collectLabelAnchors(data.features).forEach(function (a) {
        ...
        el.className = 'athar-road-label' + (a.cls === 'motorway' ? ' athar-label-major' : '');
      ...
      hoverTip.className = 'athar-hover-tip athar-gl-tip';
