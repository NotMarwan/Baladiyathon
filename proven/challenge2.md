...
| 4 | **Chelsea, MA risk-based housing inspection** — Harvard Kennedy School Ash Center (Katharine Robb et al.) + City of Chelsea, peer-reviewed 2021–22. | Integrates code violations, police/fire calls, property values into LASSO / Random Forest / XGBoost to rank properties by violation probability. | If the city inspected its 600/yr capacity by highest predicted risk, **81% expected to have a violation vs 45% under current practice** — a **1.8×** effectiveness gain. Peer-reviewed (PMC8781224). | pmc.ncbi.nlm.nih.gov/articles/PMC8781224 | Municipal study, peer-reviewed | **No** |
