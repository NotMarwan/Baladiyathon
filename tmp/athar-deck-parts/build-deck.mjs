...
const partsDir = path.join(root, "tmp", "athar-deck-parts");
const outDir = path.join(root, "output", "submission");
const finalHtml = path.join(outDir, "athar-baladiyathon-judging-deck.html");
...
<title>أثر — عرض بلدياثون التفصيلي</title>
<style>
${baseCss}
